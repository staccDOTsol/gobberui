        ...
        (
          await raydium.cpmm.swap({
            poolKeys: {
              ...
              mintB: pi.mintB,
              id: pi.id,
              authority: getPdaPoolAuthority(
                new PublicKey(new PublicKey('CVF4q3yFpyQwV8DLDiJ9Ew6FFLE1vr5ToRzsXYQTaNrj'))
              ).publicKey.toBase58(),
              config: normalizedConfig,
              vault: {
                A: getPdaVault(
                  ...
                  new PublicKey(pi.id),
                  new PublicKey(pi.mintA.address)
                ).publicKey.toBase58(),
                B: getPdaVault(
                  new PublicKey('CVF4q3yFpyQwV8DLDiJ9Ew6FFLE1vr5ToRzsXYQTaNrj'),
                  new PublicKey(pi.id),
                  new PublicKey(pi.mintB.address)
                ).publicKey.toBase58()
              }
            },
            poolInfo: poolInfo2,
